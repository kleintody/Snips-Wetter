...
def subscribe_intent_callback(hermes, intentMessage):
    ...
    if intentname == "searchWeatherForecastCondition":
        conf = read_configuration_file(CONFIG_INI)
        hermes.publish_end_session(intentMessage.session_id, random.choice(weather.forecast_condition(intentMessage)))
